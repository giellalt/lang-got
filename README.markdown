...
This directory contains source files for the Gothic language morphology
...
-   <http://giellatekno.uit.no/gotdoc/index.html>
-   <https://giellalt.uit.no/tools/docu-got-manual.html>
-   <https://giellalt.uit.no/index.html>

Requirements
------------

In order to compile and use Gothic language morphology and dictionaries,
you need:
...
The Gothic language sources can be acquired using [giella SVN
